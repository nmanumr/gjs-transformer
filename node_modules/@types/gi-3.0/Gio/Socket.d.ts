...
export declare interface Socket extends GObject.Object, Gio.DatagramBased, Gio.Initable {
  ...
  connect(address: Gio.SocketAddress, cancellable: Gio.Cancellable): boolean;
...
export declare class Socket {
  ...
  /**
    ...
    */
  readonly localAddress: import('../Gio').SocketAddress;
  /**
  ...
  /**
    ...
    */
  readonly remoteAddress: import('../Gio').SocketAddress;
  /**
